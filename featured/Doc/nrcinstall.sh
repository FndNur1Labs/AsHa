...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='narcoin.conf'
CONFIGFOLDER='/root/.narcoin'
COIN_DAEMON='nrcd'
COIN_CLI='nrc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='http://nur1labs.net/lf/narcoin.zip'
...
if [ "$?" -gt "0" ];
  then
	...
	libboost-all-dev libminiupnpc-dev libzmq3-dev git wget curl libqt5gui5 libqt5core5a libqt5dbus5 qttools5-dev qttools5-dev-tools libprotobuf-dev \
	protobuf-compiler libqrencode-dev libevent-pthreads-2.0-5"
 exit 1
fi
clear
