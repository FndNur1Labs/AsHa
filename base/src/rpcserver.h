...
extern UniValue setzmubdiseed(const UniValue& params, bool fHelp);
extern UniValue getzmubdiseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzmubdi(const UniValue& params, bool fHelp);
extern UniValue dzmubdistate(const UniValue& params, bool fHelp);
