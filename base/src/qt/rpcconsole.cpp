                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMuBdIPathCustom = GetArg("-zariabackuppath", "");
    ...
    if(!strzMuBdIPathCustom.empty()) {
        ui->wallet_customzmubdibackuppath->setText(QString::fromStdString(strzMuBdIPathCustom));
        ui->wallet_customzmubdibackuppath_label->setVisible(true);
        ui->wallet_customzmubdibackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMuBdIPathCustom.empty()) && nCustomBackupThreshold > 0) {
