 ...
 */
    ...
    typeWidget->addItem(tr("Received AriA from zAriA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAriA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMuBdI));
