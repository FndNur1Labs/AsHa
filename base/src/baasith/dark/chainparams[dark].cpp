...
public:
    CMainParams()
    {
         ...
         */
        const char* pszTimestamp = "2/15/2019 - MuBdI replace AriA Platfor for zEtA";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1550403496;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 550989;
 
	hashGenesisBlock = genesis.GetHash();
        //assert(hashGenesisBlock == uint256("0x3692f11c3b7ec399f7fb239eafa34d3d4a768286f9cf34581a0bb0d68fb853e7"));
        //assert(genesis.hashMerkleRoot == uint256("0xc7b566b183c7e51d342f2b277ed142620ddf929bc5d35aabf6acf7240a991d61"));
