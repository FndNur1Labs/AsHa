...
Testb_MintAndSpend()
{
	try {
		...
		// Now spend the coin
		timer.start();
		//CoinSpend spend(gg_Params, gg_Params, *(ggCoins[0]), acc, 0, wAcc, 0, SpendType::SPEND); //(0) presstab -> Dark Protocol
		...
		//CoinSpend newSpend(gg_Params, gg_Params, ss); -> Dark Protocol
