...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"zerocoin", "getzariaseed", &getzmubdiseed, false, false, true},
        {"zerocoin", "setzariaseed", &setzmubdiseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzaria", &searchdzmubdi, false, false, true},
	{"zerocoin", "dzariastate", &dzmubdistate, false, false, true}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:45031/\n";
}
