...
#ifndef MUBDI_ZMUBDIWALLET_H
#define MUBDI_ZMUBDIWALLET_H
...
public:
    CzMuBdIWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMuBdI(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMuBdI(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif /* MUBDI_ZMUBDIWALLET_H */
