...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
        (0, uint256("0x1fbcf1f1f1d5b147bed053349ae357b90a025c0b3fbec4924cd7eca734f28e25")); //first block
	//(1000, uint256("0x000002276e394f7198d21fa756b9b77e572906f285fb4cfa289e77ccc3f3a09c")) //first checkpoint
	//(2000, uint256("0x00000100335a496601eba610fa06e879892a90210026fe1699079d34b9d92ee0")) //updates of dark and core minting
	//(3000, uint256("0x0000033ff0b81c60f8c48f0f9257fd5986a572e28209613adda8e6aae1ebe49a")) //adding minting system and automine conensus
...
public:
	...
	nInvalidAmountFiltered = 101500 * COIN; //Amount of invalid coins filtered through exchanges, that should be considered valid
        nBlockZerocoinV2 = 99999999; //!>The block that zerocoin v2 becomes active
	nEnforceNewSporkKey = 1571891093; //!> Sporks signed after Saturday, March 31, 2018 12:00:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 1562263399; //!> Fully reject old spork key after Tuesday, April 17, 2018 12:00:00 AM GMT
         ...
         */
        const char* pszTimestamp = "2/15/2019 - MuBdI replace AriA Platform for QaWiYyu";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0448a73c22973cf97c521578117a7fdfe88fdf4874f810bc77b718602661ee485417f22f9d8bcf50a00cf7201d34b5e70733d2e2122582dc76b4867b099fc7c1a2") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1574811559;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 455098;
 
	hashGenesisBlock = genesis.GetHash();
	assert(hashGenesisBlock == uint256("0x1fbcf1f1f1d5b147bed053349ae357b90a025c0b3fbec4924cd7eca734f28e25"));
        assert(genesis.hashMerkleRoot == uint256("0x7e307a671802083c9e7dc392344abe52b0a1f33bf9291f04bf7cd7883805db41"));

    	vSeeds.push_back(CDNSSeedData("77.55.212.99", "77.55.212.99"));             // seed1
	//vSeeds.push_back(CDNSSeedData("144.217.89.214", "144.217.89.214"));             // seed2-subchain		
...
public:
    CTestNetParams()
    {
		...
		strSporkKeyOld  = "04931a51d6b01a86b902f7436c5df534b1a46097b0bde3e74b219c567084437ba23573a273f2581cc4d1b5d3820ece44f5c2a1575b37440435e681090fbd223614";
