...
public:
    ...
    bool WriteZMuBdISeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZMuBdISeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZMuBdISeed_deprecated(uint256& seed);
    bool EraseZMuBdISeed();
    bool EraseZMuBdISeed_deprecated();

    bool WriteZMuBdICount(const uint32_t& nCount);
    bool ReadZMuBdICount(uint32_t& nCount);
