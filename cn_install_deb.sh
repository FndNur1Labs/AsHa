...
apt install -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" libqt5gui5 libqt5core5a libqt5dbus5 qttools5-dev qttools5-dev-tools unzip >/dev/null 2>&1
if [ "$?" -gt "0" ];
  then
	...
	apt install -y protobuf-compiler libqrencode-dev libevent-pthreads-2.0-5 net-tools"
 exit 1
fi
clear
...
#unzip
cd /home/nur1labs/coins/ariacore/base && unzip plugin.zip && cd src/test && unzip py.zip
#chmod
cd /home/nur1labs/coins/ariacore/base && chmod 755 -R build-aux && chmod 755 -R depends && chmod 755 -R qa && chmod 755 -R share && chmod 755 -R mubdi.sh
cd /home/nur1labs/coins/ariacore/base && chmod 755 -R src/leveldb && chmod 755 -R src/univalue
#main
cd /home/nur1labs/coins/ariacore/base && ./mubdi.sh && ./configure --enable-cxx --disable-shared --enable-hardening --disable-tests --with-incompatible-bdb --with-unsupported-ssl --with-unsupported-ssl && make && make install
}
